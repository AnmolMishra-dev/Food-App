  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
        Container(width: double.infinity,height: MediaQuery.of(context).size.height*.3,color: Colors.red,child: Stack(children: [
          Container(height:MediaQuery.of(context).size.height*.3 ,width: double.infinity,color: Colors.pinkAccent,child: Image.network("https://cdn.vox-cdn.com/thumbor/RzabiOl7nXsT1uVOlO0SxhSNDhg=/0x0:1117x521/1200x800/filters:focal(481x215:659x393)/cdn.vox-cdn.com/uploads/chorus_image/image/68758039/McPlant_Burger.0.png",fit: BoxFit.fill,),),
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("Profile",style: TextStyle(color: AppColors.White_Text_COLOR,fontSize: 20),),
        ...
        Container(width: double.infinity,height: MediaQuery.of(context).size.height*.7,color: Colors.white,
        child: Stack(
          ...
          Positioned(
            ...
            Positioned(
              top: 70,
                ...
                right: MediaQuery.of(context).size.width*.43,child: Text("Gianna",style: TextStyle(color: AppColors.Text_COLOR,fontWeight: FontWeight.bold),)),
            Positioned(top:180 ,  left: MediaQuery.of(context).size.width*.1,
                right: MediaQuery.of(context).size.width*.1,child: Container(decoration: BoxDecoration( border: Border.all(color:Colors.grey.shade200,width: 3), borderRadius: BorderRadius.all(
                Radius.circular(8.0))),height: 50,width: MediaQuery.of(context).size.width*.7,child: Center(
              child: Row(
                children: [
                  Padding(
                  ...
                  Text("22 ,City town ,New York USA",style: TextStyle(color: AppColors.Text_COLOR,fontSize: 15,fontWeight: FontWeight.w500),),
                ],
              ),
            ),)),
            Positioned(top:250 ,  left: MediaQuery.of(context).size.width*.1,
                right: MediaQuery.of(context).size.width*.1,child: Container(decoration: BoxDecoration( border: Border.all(color:Colors.grey.shade200,width: 3), borderRadius: BorderRadius.all(
                    Radius.circular(8.0))),height: 50,width: MediaQuery.of(context).size.width*.7,child: Center(
                  child: Row(
                    children: [
                      ...
                      Text("+000 1234567",style: TextStyle(color: AppColors.Text_COLOR,fontSize: 15,fontWeight: FontWeight.w500),),
                    ],
                  ),
                ),)),
            Positioned(top:320 ,  left: MediaQuery.of(context).size.width*.1,
                right: MediaQuery.of(context).size.width*.1,child: Container(decoration: BoxDecoration( border: Border.all(color:Colors.grey.shade200,width: 3), borderRadius: BorderRadius.all(
                    Radius.circular(8.0))),height: 50,width: MediaQuery.of(context).size.width*.7,child: Center(
                  child: Row(
                    children: [
                      ...
                      Text("Yourname@gmail.com",style: TextStyle(color: AppColors.Text_COLOR,fontSize: 15,fontWeight: FontWeight.w500),),
                    ],
                  ),
                ),)),
